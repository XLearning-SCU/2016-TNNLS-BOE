...
addpath ('../usages/');
% accumulate the events into segments or not
isSkipProceeEvent = false;

dataSet = 'cards_100_seq';
rand('state',4);% to reproduce our result

nEvt  = 100;       % each frame consists of nEvt events.
...
for i = 1:nRounds
    ...
    % reweight the vector using weight
    tic;
