...
dataSet = 'posture_2timesIn1CIN_32x32';

nEvt  = 500;       % each frame consists of nEvt events.
tr_rate = 80;      % use tr_rate percent data set for training purpose, and use the rest for testing
